...
<div id="footer">
<p id="copy">&copy; <?php echo date("Y"); ?> <a href="<?php echo ($user_site ? $user_site : $site_url); ?>"><?php echo htmlentities($user_fullname ? $user_fullname : $user_name); ?></a>. All Rights Reserved.</p>
